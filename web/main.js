...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStreams(stream1) {
	    var stream2 = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function toArray(obj) {
	  ...
	  !(!Array.isArray(obj) && ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' || typeof obj === 'function')) ?  false ? invariant(false, 'toArray: Array-like object expected') : invariant(false) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginHub = {
	  ...
	  putListener: function putListener(id, registrationName, listener) {
	    !(typeof listener === 'function') ?  false ? invariant(false, 'Expected %s listener to be a function, instead got type %s', registrationName, typeof listener === 'undefined' ? 'undefined' : _typeof(listener)) : invariant(false) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function instantiateReactComponent(node) {
	  ...
	  if (node === null || node === false) {
	    ...
	    var element = node;
	    !(element && (typeof element.type === 'function' || typeof element.type === 'string')) ?  false ? invariant(false, 'Element type is invalid: expected a string (for built-in components) ' + 'or a class/function (for composite components) but got: %s.%s', element.type == null ? element.type : _typeof(element.type), getDeclarationErrorAddendum(element._owner)) : invariant(false) : undefined;
	    ...
	    instance = ReactNativeComponent.createInstanceForText(node);
	     ...
	     true ?  false ? invariant(false, 'Encountered invalid React node of type %s', typeof node === 'undefined' ? 'undefined' : _typeof(node)) : invariant(false) : undefined;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  mountComponent: function mountComponent(rootID, transaction, context) {
	    ...
	    !((typeof initialState === 'undefined' ? 'undefined' : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ?  false ? invariant(false, '%s.state: must be set to an object or null', this.getName() || 'ReactCompositeComponent') : invariant(false) : undefined;
	  ...
	  _processChildContext: function _processChildContext(currentContext) {
	    ...
	    if (childContext) {
	      !(_typeof(Component.childContextTypes) === 'object') ?  false ? invariant(false, '%s.getChildContext(): childContextTypes must be defined in order to ' + 'use getChildContext().', this.getName() || 'ReactCompositeComponent') : invariant(false) : undefined;
	      if (false) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function assertValidProps(component, props) {
	  ...
	  if (props.dangerouslySetInnerHTML != null) {
	    ...
	    !(_typeof(props.dangerouslySetInnerHTML) === 'object' && HTML in props.dangerouslySetInnerHTML) ?  false ? invariant(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. ' + 'Please visit https://fb.me/react-invariant-dangerously-set-inner-html ' + 'for more information.') : invariant(false) : undefined;
	  }
	  if (false) {
	    process.env.NODE_ENV !== 'production' ? warning(props.innerHTML == null, 'Directly setting property `innerHTML` is not permitted. ' + 'For more information, lookup documentation on `dangerouslySetInnerHTML`.') : undefined;
	    process.env.NODE_ENV !== 'production' ? warning(!props.contentEditable || props.children == null, 'A component is `contentEditable` and contains `children` managed by ' + 'React. It is now your responsibility to guarantee that none of ' + 'those nodes are unexpectedly modified or duplicated. This is ' + 'probably not intentional.') : undefined;
	  }
	  !(props.style == null || _typeof(props.style) === 'object') ?  false ? invariant(false, 'The `style` prop expects a mapping from style properties to values, ' + 'not a string. For example, style={{marginRight: spacing + \'em\'}} when ' + 'using JSX.%s', getDeclarationErrorAddendum(component)) : invariant(false) : undefined;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mergeIntoWithNoDuplicateKeys(one, two) {
	  !(one && two && (typeof one === 'undefined' ? 'undefined' : _typeof(one)) === 'object' && (typeof two === 'undefined' ? 'undefined' : _typeof(two)) === 'object') ?  false ? invariant(false, 'mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects.') : invariant(false) : undefined;
	...
	var ReactClass = {
	  ...
	  createClass: function createClass(spec) {
	    var Constructor = function Constructor(props, context, updater) {
	      ...
	      !((typeof initialState === 'undefined' ? 'undefined' : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ?  false ? invariant(false, '%s.getInitialState(): must return an object or null', Constructor.displayName || 'ReactCompositeComponent') : invariant(false) : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactComponent.prototype.setState = function (partialState, callback) {
	  !((typeof partialState === 'undefined' ? 'undefined' : _typeof(partialState)) === 'object' || typeof partialState === 'function' || partialState == null) ?  false ? invariant(false, 'setState(...): takes an object of state variables to update or a ' + 'function which returns an object of state variables.') : invariant(false) : undefined;
	  if (false) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _streams = __webpack_require__(156);

	var _reactSelectPlus = __webpack_require__(157);
	...
	var TwitchStreamPicker = function (_React$Component) {
	    _inherits(TwitchStreamPicker, _React$Component);

	    function TwitchStreamPicker() {
	        _classCallCheck(this, TwitchStreamPicker);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TwitchStreamPicker).call(this));

	        _this.state = { stream: null };
	        return _this;
	    }

	    _createClass(TwitchStreamPicker, [{
	        key: 'setStream',
	        value: function setStream(value) {
	        ...
	        value: function render() {
	            var options = getOptions(this.props.teams);
	            var stream = this.state.stream || this.props.stream;
	            console.log('stream', stream);

	            return _react2.default.createElement(_reactSelectPlus2.default, {
	...
	var App = function (_React$Component2) {
	    ...
	    _createClass(App, [{
	        key: 'render',
	        value: function render() {
	            var stream1 = this.props.streams.length ? _react2.default.createElement(_streams.TwitchStream, { stream: this.props.streams[0] }) : '';
	            var stream2 = this.props.streams.length > 1 ? _react2.default.createElement(_streams.TwitchStream, { stream: this.props.streams[1] }) : '';
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-sm-6' },
	                            _react2.default.createElement(TwitchStreamPicker, {
	...
	function getOptions(teams) {
	    return teams.map(function (team) {
	        return {
	            label: team.name,
	            options: team.twitch.map(function (twitch) {
	                return {
	                    label: twitch,
	                    value: twitch
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TwitchStream = exports.TwitchChatRoom = exports.TwitchIframe = undefined;
	...
	var TwitchIframe = exports.TwitchIframe = function (_React$Component) {
	    _inherits(TwitchIframe, _React$Component);

	    function TwitchIframe() {
	        _classCallCheck(this, TwitchIframe);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TwitchIframe).apply(this, arguments));
	    }

	    _createClass(TwitchIframe, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'twitch-iframe', ref: 'wrapper' },
	...
	var TwitchChatRoom = exports.TwitchChatRoom = function (_React$Component2) {
	    _inherits(TwitchChatRoom, _React$Component2);

	    function TwitchChatRoom() {
	        _classCallCheck(this, TwitchChatRoom);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TwitchChatRoom).apply(this, arguments));
	    }

	    _createClass(TwitchChatRoom, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var iframe = this.refs.iframe;
	            var wrapper = this.refs.wrapper;
	            ...
	            var metrics = getMetrics();
	            var width = Math.min(window.innerWidth - metrics.width, 310);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'twitch-chat', ref: 'wrapper' },
	                _react2.default.createElement('iframe', {
	                    ref: 'iframe',
	...
	var TwitchStream = exports.TwitchStream = function (_React$Component3) {
	    _inherits(TwitchStream, _React$Component3);

	    function TwitchStream() {
	        _classCallCheck(this, TwitchStream);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TwitchStream).apply(this, arguments));
	    }

	    _createClass(TwitchStream, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(TwitchIframe, { username: this.props.stream }),
	                _react2.default.createElement(TwitchChatRoom, { username: this.props.stream })
	            );
	        }
	    }]);
	...
	var Streams = function (_React$Component4) {
	    _inherits(Streams, _React$Component4);
	    ...
	    _createClass(Streams, [{
	        key: 'render',
	        value: function render() {
	            var twitchStreams = this.props.streams.map(function (stream) {
	                return _react2.default.createElement(TwitchStream, { className: 'stream', key: 'stream-' + stream, username: stream });
	            });

	            return _react2.default.createElement(
	                'div',
	                { className: 'streams container-fluid' },
	                twitchStreams,
	                this.props.children
	            );
	        }
	...
	function getMetrics() {
	    var height = (window.innerHeight - 58) / 2;
	    var width = height * 1.64021164021164;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactInputAutosize = __webpack_require__(158);
	...
	var _utilsStripDiacritics = __webpack_require__(161);
	...
	var _Option = __webpack_require__(164);
	...
	var _Value = __webpack_require__(166);
	...
	var Select = _react2['default'].createClass({
		...
		renderClear: function renderClear() {
			...
			return _react2['default'].createElement('span', { className: 'Select-clear-zone', title: this.props.multi ? this.props.clearAllText : this.props.clearValueText,
				...
				onTouchEnd: this.handleTouchEndClearValue }, _react2['default'].createElement('span', { className: 'Select-clear', dangerouslySetInnerHTML: { __html: '&times;' } }));
		},

		renderArrow: function renderArrow() {
			return _react2['default'].createElement('span', { className: 'Select-arrow-zone', onMouseDown: this.handleMouseDownOnArrow }, _react2['default'].createElement('span', { className: 'Select-arrow', onMouseDown: this.handleMouseDownOnArrow }));
		},
		...
		render: function render() {
			...
			return _react2['default'].createElement('div', { ref: 'wrapper', className: className, style: this.props.wrapperStyle }, this.renderHiddenField(valueArray), _react2['default'].createElement('div', { ref: 'control',
				...
				onTouchStart: this.handleTouchStart,
				onTouchMove: this.handleTouchMove }, this.renderValue(valueArray, isOpen), this.renderInput(valueArray), this.renderLoading(), this.renderClear(), this.renderArrow()), isOpen ? _react2['default'].createElement(Dropdown, null, _react2['default'].createElement('div', { ref: 'menuContainer', className: 'Select-menu-outer', style: this.props.menuContainerStyle }, _react2['default'].createElement('div', { ref: 'menu', className: 'Select-menu',
				style: this.props.menuStyle,
				onScroll: this.handleMenuScroll,
				onMouseDown: this.handleMouseDownOnMenu }, this.renderMenu(options, !this.props.multi ? valueArray : null, focusedOption)))) : null);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
		...
		} else if ("function" === 'function' && _typeof(__webpack_require__(160)) === 'object' && __webpack_require__(160)) {
	...
	var OptionGroup = _react2['default'].createClass({
		...
		render: function render() {
			...
			return option.disabled ? _react2['default'].createElement('div', { className: className,
				...
				onTouchMove: this.handleTouchMove,
				onTouchEnd: this.handleTouchEnd,
				title: option.title }, _react2['default'].createElement('div', { className: 'Select-option-group-label' }, this.props.label), this.props.children);
		}
	});
